...
//add levels here for play mode i.e easy , hard etc. the higher the speed the lower the movement
        // ----- public variables -----
        me.snakeBody = {};
        ...
        */
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (highScore == undefined) localStorage.setItem('jsSnakeHighScore', (me.snakeLength-1));
                if (me.snakeLength > highScore) {
                    alert('Congrats! You have the new high score');
                        localStorage.setItem('jsSnakeHighScore', (me.snakeLength-1));
                }
}
            recordScore();
...
// private functions
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Snake Game<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<p></p>Game Over!<p></p>";
...
// public functions
        ...
        */   
        me.resetBoard = function() {
            ...
            mySnake.reset();
            elmLengthPanel.innerHTML = "Score: ";
...
//add levels here for playmode
        ...
        */ 
        me.foodEaten = function() {
            elmLengthPanel.innerHTML = "Score: " + (mySnake.snakeLength-1);
            myFood.randomlyPlaceFood();
        };
...
function getHighScore () {
    document.getElementById('high-score').addEventListener('click', function () {
        if (localStorage.jsSnakeHighScore == undefined) alert('No Score yet!');
        else
    alert('Current high score is ' + localStorage.jsSnakeHighScore + '.'); });
}
getHighScore();
